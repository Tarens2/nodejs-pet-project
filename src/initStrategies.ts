...
export default function initStrategies() {
    ...
    passport.use(new GithubStrategy(GITHUB_CONFIG, StrategyController.githubStrategy));
    passport.use(new LocalStrategy(LOCAL_CONFIG, StrategyController.localStrategy ));
